		...
		<div class="team-member division">
			...
			<div class="row text-center">
				...
				<div class="col-md-3 ">
					<div class="mx-auto">
						<img
							src="image\JPEG-photo.jpeg"
							class="rounded z-depth-1-half">
					</div>
					<h4 class="font-weight-bold dark-grey-text my-4">Adinath Ingole</h4>
				...
				<div class="col-md-3">
					<div class="mx-auto">
						<img
							src="image\Swapnil.jpeg"
							class="rounded z-depth-1-half">
					</div>
					<h4 class="font-weight-bold dark-grey-text my-4">Swapnil Jadhav</h4>
					<h6 class="text-uppercase grey-text mb-3">
						<strong>Web Developer</strong>
					</h6>
					<!--Linkedin -->
