	...
	<div class="about">
		...
		<div class="row division about-body">
			...
			<div class="col-lg-6 column">
				...
				<h1 class="heading1 about-animate">
					We Are A Team Of Experts <br>In This Field...
				</h1>
				<p class="about-info">We work for establishment of communication
					between different service provider and user/ client.We bring
					multiple service provider at one place for user convinience.</p>
		...
		<div class="team-member division">
			<section class="team-section text-center my-5"> <!-- Section heading -->
			...
			<div class="row text-center">
				...
				<div class="col-md-3">
					<div class="avatar mx-auto">
						<img src="image\JPEG-photo.jpeg" class="rounded z-depth-1-half">
					</div>
					<h4 class="font-weight-bold dark-grey-text my-4">Adinath
						Ingole</h4>
				...
				<div class="col-md-3">
					<div class="mx-auto">
						<img src="image\Bhushan.jpeg" class="rounded z-depth-1-half">
					</div>
					<h4 class="font-weight-bold dark-grey-text my-4">Bhushan Patil</h4>
					<h6 class="text-uppercase grey-text mb-3">
						<strong>Web Developer</strong>
					</h6>
					<!--Linkedin -->
				...
				<div class="col-md-3">
					<div class="avatar mx-auto">
						<img src="image\Swapnil.jpeg" class="rounded z-depth-1-half"
							alt="Sample avatar">
					</div>
					<h4 class="font-weight-bold dark-grey-text my-4">Swapnil
						Jadhav</h4>
					<h6 class="text-uppercase grey-text mb-3">
						<strong>Web Developer</strong>
					</h6>
		...
		<div class="footer bg-dark text-light">
			<!-- Footer -->
			<footer class="page-footer"> <!-- Footer Elements --> <!-- <div class="container">
			...
			</div> --> <%@ include file="socialmedia.jsp"%>
			<!-- Footer Elements --> <!-- Copyright --> <!-- <div class="footer-copyright text-center py-3">© 2021 Copyright
				:Service Hub</div> --> <!-- Copyright --> </footer>
			<!-- Footer -->
