		...
		<div class="control">
			<div class="row">
				<div class="col-lg-12">
					...
					<br>
					<h45>
					<a href="getAllSpForUser" id="l1" class="btn btn-primary"
						role="button"> All Services</a></h45>

					<jstl:forEach items="${list}" var="li">
						<h45 style="padding-left: 100px"> <a
							href="DrelatedSP?des=${li.designation}" id="l2"
							class="btn btn-primary" role="button">${li.designation}</a></h45>
					</jstl:forEach>
