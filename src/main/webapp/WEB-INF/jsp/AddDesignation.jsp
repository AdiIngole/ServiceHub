...
<form action="addDesignation" method="post" style="margin-left:500px;margin-top:100px">
Enter new Designation:
 <input autocomplete="off" type="text" name="designation" placeholder="Enter a designation">
 <input autocomplete="off" type="submit" value="Add" class="btn btn-success">
${msg}
</form>
