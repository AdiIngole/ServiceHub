...
<body>
	...
	<div class="main container-fluid" id="main">
		<form class="form-group" action="ServiceProviderLogin" method="post">
			<!-- heading -->
			...
			<div class="control">
				<div class="row">
					<div class="col-lg-12">
						<!-- first name -->
						<label for="First name">Service Provider Name</label> <input
						...
						<i class="fa fa-check-circle" id="userSuccess1"></i> <i
							...
							id="u1msg" class="errormsg">**invalid service provider
							name**</span>
					</div>
				</div>
			</div>
			...
			<p class="text-center create">
				...
				<a href="spGetOtpForFpass" class="btn btn-info">Forget password</a>
				<a href="Serviceprovider" class="btn btn-info">Create account</a>
			</p>
