	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<ul class="navbar-nav justify-content-ends">
			<li class="nav-item active"><a class="nav-link"
				href="serviceProviderHome">Home <span class="sr-only">(current)</span></a>
			</li>

			<li class="nav-item"><a class="nav-link"
				href="getClient?sp_uname=${sp_uname}">Client</a></li>


			<li class="nav-item"><a class="nav-link"
				href="serviceProviderAbout">About Us</a></li>

			<li class="nav-item"><a class="nav-link" href="getSpProfile">Profile</a>
			</li>
			<li class="nav-item"><a class="nav-link"
				href="serviceProviderLogout">LogOut</a></li>
