	...
	<div class="row">
		...
		<div class="col-lg-4">
			...
			<div class="container"
				...
				<form action="validAdminEmailUname" method="get">
					<div class="form-group">
						<label for="email">Email:</label> <input autocomplete="off" type="email"
							class="form-control" id="email" placeholder="Enter email"
							name="email" required>
					</div>
					<div class="form-group">
						<label for="user name">User Name:</label> <input autocomplete="off" type="text"
							class="form-control" id="pwd" placeholder="Enter User name"
							name="uname" required>
					</div>

					<div class="form-group">
						<input autocomplete="off" type="submit" class="btn btn-success" value="GET OTP">
					</div>
					${msg}
				</form>
				<form action="getValidateOtpForfpass" method="get">
					<div class="form-group">
						<label for="otp">Enter OTP:</label> <input autocomplete="off" type="text"
							class="form-control" id="pwd" placeholder="Enter otp" name="otp"
							required>
					</div>
					<div class="form-group">
						<input autocomplete="off" type="submit" value="SUBMIT" class="btn btn-success">
					</div>
					${otpmsg}
