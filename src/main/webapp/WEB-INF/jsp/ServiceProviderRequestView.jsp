...
<body class="body">
							...
							<table class="table" style="text-align: left;">
								...
								<tr>
									<%-- <td colspan="4"><b>Image :</b>&nbsp;<img
										src='getSPImage_req?id=${list.sp_id}' width="100px"
										height="100px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>QC
											:</b>&nbsp;<img src='getSpQualification_req?id=${list.sp_id}'
										width="100px" height="100px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<b>Aadhar :</b>&nbsp;<img
										src='getSpAdharImage_req?id=${list.sp_id}' width="100px"
										height="100px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Licence
											:</b> &nbsp;<img src='getSplicence_req?id=${list.sp_id}'
										width="100px" height="100px"></td> --%>

									<td colspan="4"><b>Image :</b>&nbsp;<img
										src='getSPImage_req?id=${list.sp_id}' width="100px"
										height="100px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<b>QC :</b>&nbsp; <span class="imagespdf"> <iframe
												id="spQF" name='spQF'
												src='getSpQualification_req?id=${list.sp_id}' scrolling="no"
												width="20%" height="20%" frameborder="0" allowfullscreen></iframe>
									</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Aadhar:</b>&nbsp; <span
										class="imagespdf"> <iframe id="spAddhar"
												name='spAddhar' src='getSpAdharImage_req?id=${list.sp_id}'
												scrolling="no" width="20%" height="20%" frameborder="0"
												allowfullscreen></iframe>
									</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Licence :</b>&nbsp; <span
										class="imagespdf"> <iframe id="spLicense"
												name='spLicense' src='getSplicence_req?id=${list.sp_id}'
												scrolling="no" width="20%" height="20%" frameborder="0"
												allowfullscreen></iframe>
									</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
								</tr>
								<tr>
									<td colspan="2" style="text-align: center;"><a
										href="acceptSpRequest?id=${list.sp_id}&mail=${list.email }"
										class="btn btn-success">ACCEPT</a> <a
										href="RejectServiceProvider?id=${list.sp_id}&mail=${list.email }"
	...
	<jstl:if test="${!not empty list}">
		<br>
		<br>
		<h3>Sorry ,you don't have any service provider registration
			request is available</h3>
	</jstl:if>
