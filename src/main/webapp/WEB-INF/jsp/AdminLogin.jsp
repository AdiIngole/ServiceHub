...
<body>
	...
	<div class="main container-fluid" id="main">
		<form class="form-group" action="adminLoginValidation" method="get">
			<!-- heading -->
			...
			<div class="control">
				<div class="row">
					<div class="col-lg-12">
						<!-- first name -->
						<label for="First name">Admin User Name</label> <input
						...
						<i class="fa fa-check-circle" id="userSuccess1"></i> <i
							...
							id="u1msg" class="errormsg">**invalid admin name**</span>
					</div>
				</div>
			</div>
			...
			<p class="text-center create">
				...
				<a href="adminGetOtpForfpass" class="btn btn-info">Forget
					password</a> <!-- <a href="adminRegistration" class="btn btn-info">Create
					account</a> -->
			</p>
