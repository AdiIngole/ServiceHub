...
if(session.getAttribute("sp_uname")==null)
	...
	<jstl:forEach items="${list}" var="list">
		<div class="card"
			style="width: 400px; margin-top: 100px; margin-left: 400px; background-color: rgba(116, 208, 251, 0.67);">
			...
			<div class="card-body">
				...
				<p class="card-text">Mobile NO: ${list.mobNumber}</p>
				<p class="card-text">Email : ${list.email }</p>
				<p class="card-text">Address : ${list.officeAddress}</p>
				<p class="card-text"></p>
			</div>
		</div>
	</jstl:forEach>
