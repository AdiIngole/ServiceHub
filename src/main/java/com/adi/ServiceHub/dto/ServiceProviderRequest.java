...
public class ServiceProviderRequest {
	...
	public ServiceProviderRequest(Integer sp_id, String fname, String lname, String mobNumber, String email,
	...
	public String toString() {
		return "ServiceProviderRequest [sp_id=" + sp_id + ", fname=" + fname + ", lname=" + lname + ", mobNumber="
